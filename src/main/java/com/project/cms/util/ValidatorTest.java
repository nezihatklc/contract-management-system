...
public class ValidatorTest {
    ...
    private static void testPhoneValidation() {
        System.out.println("=== Phone Validation Test ===");
        ...
        for (String phone : validPhones) {
            try {
                ...
                System.out.println("PASS: Valid phone accepted → " + phone);
    ...
    private static void testContactValidation() {
        ...
        c.setFirstName("Test");
        c.setLastName("User");
        c.setPhonePrimary("05551234567");   // Contact tablosuna uygun alan adı
